...
export function HowItWorks() {
  ...
  return (
    <section className="bg-foreground text-background" id="how-it-works">
        ...
        <div className="grid lg:grid-cols-2 lg:gap-16">
          ...
          <div className="pt-16 lg:sticky lg:top-0 lg:flex lg:h-dvh lg:flex-col lg:justify-center lg:pt-0">
            ...
            <div className="relative mt-6 min-h-[280px]">
              <AnimatePresence mode="wait">
                ...
                >
                  ...
                  <span
                    aria-hidden
                    className="pointer-events-none block font-heading text-[9rem] font-bold leading-none text-transparent sm:text-[11rem]"
                    style={{ WebkitTextStroke: "1.5px rgb(255 255 255 / 0.22)" }}
                  >
                    {step.number}
                  </span>
            ...
            <div className="mt-10 flex items-center gap-4">
              <div className="relative h-[3px] w-40 overflow-hidden rounded-full bg-background/15">
                <motion.div
          ...
          <div className="flex flex-col gap-24 py-16 lg:gap-0 lg:py-0">
            {steps.map((s, i) => (
              <motion.div
                key={s.number}
              ...
              >
                ...
                >
                  <ImagePlaceholder
                    ...
                    className="aspect-[5/4] w-full rounded-[2rem] border-background/20 bg-background/5 text-background/50"
                  />
                </motion.div>
              </motion.div>
            ))}
